...
export const periodicTaskAddOnServer = (periodicTask: PeriodicTask) => ({
    payload: {
        error: undefined,
        periodicTask,
    },
...
export const periodicTaskUpdateOnServer = (periodicTask: PeriodicTask) => ({
    payload: {
        error: undefined,
        periodicTask,
    },
...
export const periodicTaskDeleteOnServer = (periodicTask: PeriodicTask) => ({
    payload: {
        error: undefined,
        periodicTask,
    },
