...
const nextCloudCredentialsReducer = (nextCloudCredentials: NextCloudCredentials, action: any): NextCloudCredentials => {
    switch (action.type) {
...
const nextCloudCredentialsLoadingReducer = (nextCloudCredentialsLoading: boolean, action: any): boolean => {
    switch (action.type) {
