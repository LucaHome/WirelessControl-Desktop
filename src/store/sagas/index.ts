...
import {
  AREA_ADD, AREA_DELETE, AREAS_LOAD_SUCCESSFUL, AREA_UPDATE, AREAS_LOAD,
  NEXT_CLOUD_CREDENTIALS_LOGIN, NEXT_CLOUD_CREDENTIALS_LOGIN_SUCCESSFUL, NEXT_CLOUD_CREDENTIALS_LOGOUT,
  PERIODIC_TASK_ADD, PERIODIC_TASK_DELETE, PERIODIC_TASK_UPDATE, PERIODIC_TASKS_LOAD,
  WIRELESS_SOCKET_ADD, WIRELESS_SOCKET_DELETE, WIRELESS_SOCKETS_LOAD_SUCCESSFUL, WIRELESS_SOCKET_UPDATE, WIRELESS_SOCKETS_LOAD,
} from "../action-types";
...
function* sagas() {
  ...
  // Starts periodicTasksLoad on each dispatched WIRELESS_SOCKETS_LOAD_SUCCESSFUL action.
  yield takeEvery(WIRELESS_SOCKETS_LOAD_SUCCESSFUL, periodicTasksLoad);
  ...
  // Starts wirelessSocketsLoad on each dispatched AREAS_LOAD_SUCCESSFUL action.
  yield takeEvery(AREAS_LOAD_SUCCESSFUL, wirelessSocketsLoad);
